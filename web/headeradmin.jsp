            ...
            <div class="container">
                <div class="row">
                    <div class="col-md col-xl-4 d-flex align-items-center mb-4 mb-md-0">
                        <a class="navbar-brand align-items-center" href="admin.jsp">
                            Toothcare
            ...
            <div class="container-xl">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link ps-lg-0" href="admin.jsp">Appointments</a></li>
                        <%
                            if(session.getAttribute("user")!=null) {
                        ...
                        %>
                        <li class="nav-item"><a class="nav-link" href="profileadmin.jsp">Welcome, <%=name%></a></li>
                        <% } %>
                    </ul>
                </div>
            </div>
